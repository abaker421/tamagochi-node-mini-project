...
//user actions, available as interactable options
    ...
    cleanPet(){
        ...
        throw `${this.petName} is squeaky clean!`
    }
    ...
    feedPet(){
       ...
       if (this.fullness>100){
        ...
        throw `${this.petName} is sick from overeating`
       } else {
        throw `${this.petName} looks satisfied!`
       }
    }
    ...
    playWithPet(){
        ...
        this.cleanliness-=Math.floor(Math.random()*6)-=2
        this.happiness+=15
        throw `${this.petName} had a fun time playing with you!`
    }
...
//Game Mechanics
    ...
    makeSound(){
        ...
        if (randomNumber === 0) {
          throw `${this.petName} says ${this.sound}!`
        }
    }
